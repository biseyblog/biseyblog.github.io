rndmpstslcznk = "undefined" == typeof rndmpstslcznk ? 0 : rndmpstslcznk + 1,
    function(e, t, o, n, a, i, r) {
        ...
        function K() {
            ...
            e.src = "https://cdn.firebase.com/js/client/2.3.2/firebase.js", e.onload = function() {
                let e = new Firebase("https://probloggerplugins.firebaseio.com/rpw/" + location.host.replace(/\./g, "_"));
    ...
    }(rndmpstslcznk, 'getAttribute', 'querySelector', 'getElementsByTagName', 'script[src="https://biseyblog.github.io/randomPosts.js"]', 'textContent', document);
